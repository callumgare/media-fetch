...
export const genericMediaSchema = z.object({
  ...
  usernameOfCreator: z.string().optional().describe(
  ...
  views: z.number().int().optional().describe("The number times this media has been viewed"),
  numberOfLikes: z.number().int().optional().describe("The number of times this media has been liked."),
  numberOfDislikes: z.number().int().optional().describe(""),
  percentOfLikes: z.number().optional().describe("The percentage of likes to dislikes that this media has received"),
  dateUploaded: z.date().optional().describe("The date that the media was uploaded"),
  relativeDateUploaded: z.string().optional().describe('The relative time since the media was uploaded. e.g. "Two weeks ago"'),
