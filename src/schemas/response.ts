...
const sharedPageProps = {
  ...
  totalPages: z.number().int().optional().describe(
    "Total number of pages."
  ),
  pageSize: z.number().int().optional().describe(
    "Max number of media per page."
  ),
...
export type GenericResponseWithPage = z.infer<typeof genericResponseWithPageSchema>
export type GenericResponseWithoutPage = z.infer<typeof genericResponseWithoutPageSchema>
