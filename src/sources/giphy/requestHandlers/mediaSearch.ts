...
export default {
  ...
  requestSchema: z.object({
      ...
      pageSize: z.number().optional().default(10).describe("The max number of items to be returned in a page"),
      contentRating: z.enum(giphyRatings).default("g").optional().describe("Highest allowed content rating: https://developers.giphy.com/docs/optional-settings/#rating")
    }).strict(),
